...
test.describe('Szkoła Terminala - Pick Screen', () => {
  ...
  test('selecting a car navigates to main app', async ({ page }) => {
    await page.goto('/');
...
test.describe('Szkoła Terminala - Navigation', () => {
  ...
  test('step dots are visible and clickable', async ({ page }) => {
...
test.describe('Szkoła Terminala - Terminal Interaction', () => {
  ...
  test('terminal shows prompt with user and hostname', async ({ page }) => {
    await expect(page.locator('.terminal .prompt').first()).toContainText('ania@auto-ani:~$');
  });
  ...
  test('hint button reveals command and copies to input', async ({ page }) => {
    await expect(page.getByTestId('hint-btn')).toBeVisible();
    await page.getByTestId('hint-btn').click();
    await expect(page.getByTestId('hint-copy')).toBeVisible();
    await page.getByTestId('hint-copy').click();
    const input = page.getByTestId('terminal-input');
...
test.describe('Szkoła Terminala - Different Car', () => {
  test('selecting Kuba car shows correct prompt', async ({ page }) => {
    ...
    await expect(page.locator('.terminal .prompt').first()).toContainText('kuba@auto-kuby:~$');
  });
